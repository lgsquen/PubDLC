...
public class DynamicIsland extends HudElement {
    ...
    public void onTick(EventTick e) {
        ...
        Pub.getInstance().getMediaPlayer().onTick();
    }
    ...
    public void onRender2D(EventRender2D e) {
        ...
        String name = "Pub";
        String track =  Pub.getInstance().getMediaPlayer().getLastTitle() + (Pub.getInstance().getMediaPlayer().getArtist().isEmpty() ? "" : " - " + Pub.getInstance().getMediaPlayer().getArtist());
        ...
        boolean mediaNull = Pub.getInstance().getMediaPlayer().fullNullCheck();
        ...
        if (!mediaNull && !isPvp) {
            Render2D.drawTexture(
                    ...
                    height - padding * 2,
                    4f,
                    Pub.getInstance().getMediaPlayer().getTexture(),
