...
public class DamageParticles extends Module {
    ...
    private static class Particle {
        ...
        private Identifier randomTexture() {
            ...
            if (random == 1) return Pub.id("particles/dollar.png");
            if (random == 2) return Pub.id("particles/firefly.png");
            if (random == 3) return Pub.id("particles/snow.png");

            return Pub.id("particles/star.png");
        }
    }
}