...
public class Panic extends Module {
    ...
    public void onKey(EventKey e) {
        ...
        if (e.getKey() == GLFW.GLFW_KEY_PAGE_DOWN && e.getAction() == 1 && Pub.getInstance().isPanic()) {
            ...
            Pub.getInstance().setPanic(false);
            setToggled(false);
        }
    }
}