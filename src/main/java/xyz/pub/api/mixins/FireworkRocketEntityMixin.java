...
import xyz.pub.modules.impl.movement.ElytraBooster;
import xyz.pub.utils.Wrapper;
import xyz.pub.utils.combat.BoostUtils;
...
public abstract class FireworkRocketEntityMixin extends ProjectileEntity implements Wrapper {
    ...
    public Vec3d tick(Vec3d instance, double x, double y, double z) {
        ElytraBooster elytraBooster = Pub.getInstance().getModuleManager().getModule(ElytraBooster.class);
