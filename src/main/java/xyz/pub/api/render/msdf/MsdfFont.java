package xyz.pub.api.render.msdf;
...
import xyz.pub.api.render.msdf.FontData.AtlasData;
import xyz.pub.api.render.msdf.FontData.GlyphData;
import xyz.pub.api.render.msdf.FontData.MetricsData;
import xyz.pub.api.render.providers.ResourceProvider;
...
public final class MsdfFont {
	...
	public static class Builder {
		...
		public Builder data(String dataFileName) {
			this.dataIdentifer = Pub.id("fonts/" + dataFileName + ".json");
			return this;
		}
		
		public Builder atlas(String atlasFileName) {
			this.atlasIdentifier = Pub.id("fonts/" + atlasFileName + ".png");
			return this;
		}
