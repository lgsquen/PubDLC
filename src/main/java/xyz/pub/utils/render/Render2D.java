...
import xyz.pub.api.render.builders.*;
import xyz.pub.api.render.builders.states.*;
import xyz.pub.api.render.renderers.impl.*;
import xyz.pub.api.render.builders.Builder;
import xyz.pub.api.render.builders.states.QuadColorState;
import xyz.pub.api.render.builders.states.QuadRadiusState;
import xyz.pub.api.render.builders.states.SizeState;
import xyz.pub.api.render.renderers.impl.*;
import xyz.pub.utils.Wrapper;

import xyz.pub.utils.render.fonts.Instance;
...
public class Render2D implements Wrapper {
    ...
    public void drawLine3D(double x1, double y1, double z1, double x2, double y2, double z2, Color color, float width, MatrixStack matrixStack) {

        Vec3d start = new Vec3d(x1, y1, z1);
        Vec3d end = new Vec3d(x2, y2, z2);


        Render3D.drawLine(matrixStack, start, end, color);
    }
