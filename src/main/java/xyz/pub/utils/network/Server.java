...
import xyz.pub.Pub;
import xyz.pub.api.mixins.accessors.IBossBarHud;
import xyz.pub.modules.impl.client.Targets;
import xyz.pub.modules.impl.combat.AntiBot;
import xyz.pub.modules.impl.misc.ScoreboardHealth;
...
public class Server implements Wrapper {
    ...
    public boolean isBot(PlayerEntity entity) {
        return Pub.getInstance().getModuleManager().getModule(AntiBot.class).isToggled()
        		&& Pub.getInstance().getModuleManager().getModule(AntiBot.class).bots.contains(entity);
    }

    public boolean isValid(LivingEntity entity) {
        return Pub.getInstance().getModuleManager().getModule(Targets.class).isValid(entity);
    }
    ...
    public float getHealth(LivingEntity entity, boolean gapple) {
    	if (Pub.getInstance().getModuleManager().getModule(ScoreboardHealth.class).isToggled()) {
