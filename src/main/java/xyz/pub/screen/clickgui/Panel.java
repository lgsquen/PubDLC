package xyz.pub.screen.clickgui;

import xyz.pub.Pub;
import xyz.pub.screen.clickgui.components.Component;
import xyz.pub.screen.clickgui.components.impl.ModuleComponent;
...
public class Panel implements Wrapper {
    ...
    public Panel(float x, float y, float width, float height, Category category) {
        ...
        for (Module module : Pub.getInstance().getModuleManager().getModules(category)) components.add(new ModuleComponent(module));
